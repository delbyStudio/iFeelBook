angular.module('starter.controllers', ['ngResource', 'ngAnimate'])
...
.controller('QuotesCtrl', function($scope) {
  $scope.feelings = [
    ...
    { title: 'Life', tag: "life" },
    { title: 'Inspirational', tag: "inspirational" }
  ];
})

.controller('QuoteCtrl', function($scope, $interval, $ionicLoading, $resource, $stateParams){
